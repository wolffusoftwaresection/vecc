function CreateCheckBoxOption(rootOption_object, optionsStr_array) {
    if (!(this instanceof CreateCheckBoxOption)) {
        return new CreateCheckBoxOption(rootOption_object, optionsStr_array);
    }
...
CreateCheckBoxOption.prototype = {
    init: function () {
        this.initElements();
        this.initEvent();
    },
