...
{
    public class VeccFormsPrincipal<TUserData> : IPrincipal where TUserData : class, new()
    {
        //当前用户实例
        ...
        public VeccFormsPrincipal(FormsAuthenticationTicket ticket, TUserData userData)
        {
            if (ticket == null)
        ...
        {
            var userData = UserData as VeccUserDataPrincipal;
            if (userData == null)
